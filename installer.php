...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210713_testwordpress_fbb4734eae863b113472_20210713101453_archive.zip';
	const ARCHIVE_SIZE		 = '22006344';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'fbb4734-13101453';
    const SECONDARY_PACKAGE_HASH = '5902304-13101453';
	const VERSION			 = '1.4.2';
